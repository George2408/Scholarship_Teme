...
namespace LibraryAPI.Controllers
{
    ...
    public class BookController : ControllerBase
    {
        static List<Book> _books = new List<Book>
        {
            ...
            new Book { Image ="/assets/Books/romeoAndJuliet.jpg ", BookId = new Guid("00000000-0000-0000-0000-000000000005"), Author = "William Shakespeare", Title = "Romeo and Juliet", DateOfPublication = new DateTime(1597, 1, 1), Description = "Romeo and Juliet is a tragedy written by William Shakespeare early in his career about two young Italian star-crossed lovers whose deaths ultimately reconcile their feuding families. It was among Shakespeare's most popular plays during his lifetime and, along with Hamlet, is one of his most frequently performed plays. Today, the title characters are regarded as archetypal young lovers." }
        };
